...
from env.high_level_env import high_level_testing_env, load_minute_features
from env.low_level_env import Testing_env, load_second_features
import torch
...
action_dim = 5
model_path_list = [
    f"result_risk/{DATASET_NAME}/boltzmann/beta_10.0_risk_bond_0.1/seed_12345/epoch_1/trained_model.pkl",
    f"result_risk/{DATASET_NAME}/boltzmann/beta_10.0_risk_bond_0.1/seed_12345/epoch_2/trained_model.pkl",
    f"result_risk/{DATASET_NAME}/boltzmann/beta_10.0_risk_bond_0.1/seed_12345/epoch_3/trained_model.pkl",
    f"result_risk/{DATASET_NAME}/boltzmann/beta_10.0_risk_bond_0.1/seed_12345/epoch_4/trained_model.pkl",
    f"result_risk/{DATASET_NAME}/boltzmann/beta_10.0_risk_bond_0.1/seed_12345/epoch_5/trained_model.pkl",
]


class trader(object):
    def __init__(self, dataset_name="NVDA") -> None:
        self.device = "cpu"
        # trading setting
        ...
        self.tech_indicator_list = load_second_features(dataset_name)
        self.initial_action = initial_action
        # network
        self.test_path = (
            f"result_risk/{dataset_name}/boltzmann/beta_10.0_risk_bond_0.1/seed_12345/epoch_2"
        )
        self.hidden_nodes = 128
        self.input_dim = len(
            np.load(f"data/feature/{dataset_name}/second_feature.npy", allow_pickle=True)
        )
...
if __name__ == "__main__":
    df = pd.read_feather(f"data/{DATASET_NAME}/valid.feather").iloc[:100000]
    ...
    low_level_agent = trader(dataset_name=DATASET_NAME)
