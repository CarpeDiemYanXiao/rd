...
parser.add_argument(
    "--test_path",
    type=str,
    default="result_risk/NVDA/beta_-90.0_risk_bond_0.1/seed_12345/epoch_1",
    help="the path of test model",
)
parser.add_argument(
    "--test_df_path",
    type=str,
    default="data/NVDA/valid",
    help="the path of test model",
)
# path
parser.add_argument(
...
parser.add_argument(
    ...
    type=str,
    default="NVDA",
    help="the dataset name for loading features",
)
...
class trader(object):
    def __init__(self,args) -> None:
        ...
        self.tech_indicator_list = np.load(f"data/feature/{args.dataset_name}/second_feature.npy").tolist()
        ...
        self.input_dim=len(np.load(f"data/feature/{args.dataset_name}/second_feature.npy",allow_pickle=True))
